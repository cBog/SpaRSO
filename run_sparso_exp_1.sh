...
python train.py --run-description "${description} initial density = 0.1" --batch-size 1024 --optimiser spaRSO --opt-iters 1 --initial-density 0.1 --maximum-density 1.0 --batch-mode every_weight --norm-type batch --const-norm-weights --phases improve